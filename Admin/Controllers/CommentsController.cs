...
namespace Admin.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Text,Date,Verified,PostId,UserId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Text,Date,Verified,PostId,UserId")] Comment comment)
        {
            if (ModelState.IsValid)
            {
